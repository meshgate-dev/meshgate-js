...
type ExternalApprovalStatus = 'pending' | 'approved' | 'rejected' | 'expired' | 'cancelled';
type ExternalApprovalTerminalStatus = Exclude<ExternalApprovalStatus, 'pending'>;
type ExternalApprovalRiskLevel = 'low' | 'medium' | 'high' | 'critical';
type ExternalApprovalResumeMode = 'poll' | 'events';
type ExternalApprovalRoleHint = 'viewer' | 'operator' | 'admin';
type ExternalApprovalEvidenceType = 'policy_decision' | 'risk_signal' | 'tool_arguments' | 'runtime_trace' | 'human_note';
type ExternalApprovalEvidenceOutcome = 'allowed' | 'gated' | 'blocked' | 'flagged' | 'informational';
type ExternalApprovalRedactionState = 'none' | 'summary_only' | 'redacted' | 'external_ref_only';
interface ExternalApprovalEvidenceInput {
...
interface ExternalApprovalRequestInput {
    agentId?: string;
    sourceSystem: string;
...
interface ExternalApprovalEvidenceAppendInput extends ExternalApprovalEvidenceInput {
    idempotencyKey: string;
}
...
interface ExternalApprovalEvidence {
    id: string;
    evidenceType: ExternalApprovalEvidenceType;
    label: string;
    summary: string;
...
interface ExternalApprovalEventFilter {
    entityType: 'approval';
    entityId: string;
    eventTypes: Array<'approval.approved' | 'approval.rejected' | 'approval.expired'>;
}
interface ExternalApprovalStatusResponse {
    approvalId: string;
...
type ExternalApprovalTerminalResponse = ExternalApprovalStatusResponse & {
    status: ExternalApprovalTerminalStatus;
};
interface DataEnvelope<T> {
    data: T;
}
type ExternalApprovalEvidenceEnvelope = DataEnvelope<ExternalApprovalEvidence>;
...
declare class MeshgateApiClient {
    private readonly baseUrl;
    private readonly headers;
    constructor(apiKey: string, baseUrl: string);
    registerIntent(req: IntentRequest): Promise<IntentResponse>;
    getApprovalStatus(approvalId: string): Promise<ApprovalStatusResponse>;
    createApprovalRequest(req: ExternalApprovalRequestInput): Promise<ExternalApprovalStatusResponse>;
    getExternalApprovalRequest(approvalId: string): Promise<ExternalApprovalStatusResponse>;
    appendApprovalRequestEvidence(approvalId: string, req: ExternalApprovalEvidenceAppendInput): Promise<ExternalApprovalEvidenceEnvelope['data']>;
...
interface MeshgateApprovalClientConfig {
    apiKey: string;
    baseUrl?: string;
}
interface ExternalApprovalWaitOptions {
    pollIntervalMs?: number;
    timeoutMs?: number;
    signal?: AbortSignal;
}
declare class MeshgateApprovalClient {
    ...
    addEvidence(approvalId: string, input: ExternalApprovalEvidenceAppendInput): Promise<ExternalApprovalEvidence>;
    waitForDecision(approvalId: string, options?: ExternalApprovalWaitOptions): Promise<ExternalApprovalTerminalResponse>;
}
...
export { type ExternalApprovalDecision as E, type GuardOptions as G, MeshgateClient as M, type StoredGateRecord as S, type MeshgateStorageAdapter as a, type ExternalApprovalEventFilter as b, type ExternalApprovalEvidence as c, type ExternalApprovalEvidenceAppendInput as d, type ExternalApprovalEvidenceInput as e, type ExternalApprovalEvidenceOutcome as f, type ExternalApprovalEvidenceType as g, type ExternalApprovalRedactionState as h, type ExternalApprovalRequestInput as i, type ExternalApprovalResumeMode as j, type ExternalApprovalRiskLevel as k, type ExternalApprovalRoleHint as l, type ExternalApprovalStatus as m, type ExternalApprovalStatusResponse as n, type ExternalApprovalTerminalResponse as o, type ExternalApprovalTerminalStatus as p, type ExternalApprovalWaitOptions as q, type GateInfo as r, type GateLifecycleHook as s, type GateOrphanedEvent as t, type GateOrphanedReason as u, type GatePayload as v, MeshgateApprovalClient as w, type MeshgateApprovalClientConfig as x, type MeshgateConfig as y };
